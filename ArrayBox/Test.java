...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        bo.add ( new
                ...
                Osoba ( "Kowalski", 19 ) );                        // nazwisko = "Kowalki", wiek = 19
        bo.add ( new

                Student ( "Kowalska", 18, 100 ) );                    // nazwisko, wiek, grupa = 100
        bo.add ( new

                Student ( "Kowalska", 20, 200 ) );
       ...
       // bo.addAll ( to );
        ...
        bst.add ( new
                ...
                Student ( "Nowacka", 24, 100 ) );
        bst.add ( new

                Student ( "Nowacka", 24, 300 ) );
        bst.add ( new

                Student ( "Nowacka", 24, 200 ) );
